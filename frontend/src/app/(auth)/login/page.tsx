    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 text-gray-900">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-500 mb-3">
            <Package className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-2xl font-bold">Hina WMS</h1>
          <p className="text-sm text-gray-500">Hệ thống quản lý kho</p>
        </div>
